...
char *ICACHE_FLASH_ATTR supla_esp_board_cfg_html_template(
  ...
  static char html_template_header[] =
      ...
      "}"
      "setTimeout(function(){var element =  "
      "document.getElementById('msg');if ( element != null ) "
      "element.style.visibility = \"hidden\";},3200);"
      "</script>";
  static char html_template[] =
      ...
      "type=\"number\" value=\"%i\"><label>HOLD TIME : "
      "</label></i><i><input name=\"t11\" type=\"number\" "
      "value=\"%i\"><label>MULTICLICK TIME : </label></i>"
  ...
  ets_snprintf(
	  ...
	  supla_esp_cfg.Time1[0],
      supla_esp_cfg.Time1[1],
