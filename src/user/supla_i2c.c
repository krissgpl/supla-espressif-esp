...
uint8 ICACHE_FLASH_ATTR I2C_WriteData(uint8 device_addr, uint8 register_addr, uint8* data, uint8 length)	// dodanie z I2C.c
{
	uint8 cnt = 0;
...
uint8 ICACHE_FLASH_ATTR I2C_ReadData(uint8 device_addr, uint8 register_addr, uint8* data, uint8 length)		// dodanie z I2C.c
{
	uint8 cnt;
